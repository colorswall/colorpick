export const PALETTES = [
    {
        ...
        name: 'red',
        title: 'Red',
        colors: ['#FFEBEE', '#FFCDD2', '#EF9A9A', '#E57373', '#EF5350', '#F44336', '#E53935', '#D32F2F', '#C62828', '#B71C1C', '#FF8A80', '#FF5252', '#FF1744']
    },
    {
        id: 2,
        name: 'pink',
        title: 'Pink',
        colors: ['#F8BBD0', '#F48FB1', '#F06292', '#EC407A', '#E91E63', '#D81B60', '#C2185B', '#AD1457', '#880E4F']
    },
    {
        id: 3,
        name: 'purple',
